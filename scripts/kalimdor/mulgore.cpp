...
SDName: Mulgore
SD%Complete: 100
SDComment: Quest support: 11129, 772. Skorn Whitecloud: Just a story if not rewarded for quest
SDCategory: Mulgore
EndScriptData */
...
bool GossipHello_npc_skorn_whitecloud(Player* pPlayer, Creature* pCreature)
{
    ...
    if (!pPlayer->GetQuestRewardStatus(770))
        pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Erzählt mir eine Geschichte, Skorn.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF);
